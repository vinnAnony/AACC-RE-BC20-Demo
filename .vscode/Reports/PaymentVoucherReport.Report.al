report 50024 "Payment Voucher Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './PaymentVoucherReport.rdlc';
    ...
    dataset
    {
        dataitem("Payment Voucher Header"; "Payment Voucher Header")
        {
            ...
            dataitem("Payment Voucher Line"; "Payment Voucher Line")
            {
                ...
                begin
                    AccountName := '';
                    case "Payment Voucher Line"."Account Type" of
                        "Payment Voucher Line"."Account Type"::Supplier:
                            begin
                                //    Vendoracc.SETFILTER("No.","Payment Voucher Line"."Account No.");
                                Vendoracc.Get("Payment Voucher Line"."Account No.");
                                AccountName := Vendoracc.Name;
                            end;
                        "Payment Voucher Line"."Account Type"::Customer:
                            begin
                                //    Customeracc.SETFILTER("No.", "Payment Voucher Line"."Account No.");
                                Customeracc.Get("Payment Voucher Line"."Account No.");
                                AccountName := Customeracc.Name;
                            end;

                        "Payment Voucher Line"."Account Type"::"G/L Account":
                            begin
                                //    GLAccount.SETFILTER("No.", "Payment Voucher Line"."Account No.");
                                GLAccount.Get("Payment Voucher Line"."Account No.");
                                AccountName := GLAccount.Name;
                            end;
                        "Payment Voucher Line"."Account Type"::"Bank Account":
                            begin
                                BankAccount.Get("Payment Voucher Line"."Account No.");
