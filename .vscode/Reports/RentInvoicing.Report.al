report 50023 "Rent Invoicing"
{
    DefaultLayout = RDLC;
    RDLCLayout = './RentInvoicing.rdlc';
        ...
        dataitem("Rent Contract Header"; "Rent Contract Header")
        {
            ...
            dataitem(Contract; "Rent Contract Line")
            {
                ...
                begin
                    ...
                    if Post = true then begin
                        ...
                        SL."No." := ResSetup."Service Charge Ac";
                        ...
                        SL.Validate(Quantity, Contract."No of Units");
                        SL.Validate("Unit Price", "Rent Contract Header"."Service Charge");
                        SL."Contract Code" := Contract."Contract No.";
                        SL.Insert;
                    end;
                end;
            ...
            begin
                if Post = true then begin
                    ...
                    SH.Validate("Document Date", EndDate);
