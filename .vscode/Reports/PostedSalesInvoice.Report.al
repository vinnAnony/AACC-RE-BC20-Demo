report 50026 "Posted Sales - Invoice"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(Contract_SalesInvoiceHeader; "Contract No")
            {
            }
            column(PeriodName_SalesInvoiceHeader; "Sales Invoice Header"."Period Name")
            {
            }
            column(TTAmount__; TTAmount)
            {
            }
            column(VATProdCode__; VATProdCode)
            {
            }
            column(TTVAT__; TTVAT)
            {
            }
            column(TTAmountInclVAT__; TTAmountInclVAT)
            {
            }
            // column(ETRDate; "Sales Invoice Header"."ETR DateTime")
            // {
            // }
            // column(ETRInvoiceNo; "Sales Invoice Header"."ETR Mtn")
            // {
            // }
            // column(ETRSerialNo; "Sales Invoice Header"."ETR Msn")
            // {
            // }
            ...
            //         {
            //         }
            //         column(CompanyInfoPaymentRoutingNo; CompanyInfo."Payment Routing No.")
            //         {
            //         }
            ...
            //             {
            //             }
            //             column(Noofunits; "Sales Invoice Line"."No. of Units")
            //             {
            //             }
            //             column(Type; "Sales Invoice Line"."Resource Sub Type")
            //             {
            //             }
            //             column(No_SalesInvLine; "No.")
            //             {
            //             }
            //             column(Total_Amount; "Sales Invoice Line"."Total Amount")
            //             {
            //             }
            //             column(No_of_Months; "Sales Invoice Line"."No of months")
            //             {
            //             }
            //             column(Qty_SalesInvLine; Quantity)
            //             {
            //             }
            //             column(Qty; "Sales Invoice Line"."No. of Units")
            //             {
            //             }
            ...
            //                 if "Sales Invoice Line"."No of months" = 0 then begin
            //                     "Sales Invoice Line"."No of months" := 1;
            //                     "Sales Invoice Line"."Total Amount" := 1 * "Sales Invoice Line".Amount;
            //                     Modify;
            //                 end;
            //             end;
            //         }
            ...
            begin
                ...
                */
                ...
                TTAmount := 0;
                TTVAT := 0;
                TotalSalesInvLine.SetRange("Document No.", "No.");
                if TotalSalesInvLine.Find('-') then begin
                    repeat
                        TTAmount += TotalSalesInvLine.Amount;
                    until TotalSalesInvLine.Next = 0;
                end;

                VATEntry.SetRange("Document No.", "No.");
                if VATEntry.Find('-') then begin
                    repeat
                        TTVAT += VATEntry.Amount;
                ...
                VATEntry.SetRange("Document No.", "No.");
                if VATEntry.Find('-') then begin
                    VATProdCode := VATEntry."VAT Prod. Posting Group";
                end;
                //end 06/11/2020

                TTVAT := -TTVAT;
                TTAmountInclVAT := TTVAT + TTAmount;
                //MESSAGE(' No is %1 amount is %2 vat %3 ttamtincVAT %4', "No.", TTAmount, TTVAT, TTAmountInclVAT);
                //ktm
