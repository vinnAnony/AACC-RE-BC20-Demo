page 50017 "Posted Deposit Receipt"
{
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    Editable = "Contract CodeEditable";
                }
                field("Property Code"; "Property Code")
                {
                    Editable = "Property CodeEditable";
                ...
                {
                    Editable = "Customer CodeEditable";
    ...
    trigger OnInit()
    begin
        "Contract CodeEditable" := true;
        "Customer CodeEditable" := true;
        "Property CodeEditable" := true;
    ...
    var
        ...
        [InDataSet]
        "Property CodeEditable": Boolean;
        [InDataSet]
        "Customer CodeEditable": Boolean;
        [InDataSet]
        "Contract CodeEditable": Boolean;
    ...
    begin
        ...
        if Status = Status::Released then begin
            ...
            "Property CodeEditable" := false;
            "Customer CodeEditable" := false;
            "Contract CodeEditable" := false;
        end
        else begin
            "Doc No.Editable" := true;
            "Posting DateEditable" := true;
